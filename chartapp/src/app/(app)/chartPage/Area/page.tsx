...
import chartData2 from "@/lib/graph.json"
import {
  Card,
  CardContent,
  CardDescription,
...
const newData=chartData2.response.data
...
export default function Component() {
  const [timeRange, setTimeRange] = React.useState("default")

  const filterDataByDateRange = (data, timeRange:string) => {
  ...
  const filteredData = filterDataByDateRange(newData,timeRange)

  return (
    <Card className="w-full">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          <CardTitle>Nifity 50</CardTitle>
          <CardDescription>
            Showing Nifity 50 thrends for the last { 
            (()=>{
                switch (timeRange) {
          ...
          <AreaChart data={filteredData}>
            ...
            <ChartTooltip
                ...
                return (
                    ...
                    <div><strong className="text-sm">{data.date}</strong> </div>
